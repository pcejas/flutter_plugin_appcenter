...
class AppCenter {
  ...
  static Future<String> configure(String app_secret) =>
      _channel.invokeMethod('configure', <String, dynamic>{
        'app_secret': app_secret,
      });

  static Future<dynamic> start(String app_secret, List<String> services) =>
  ...
  static Future<String> get installId async {
    return await _channel.invokeMethod('installId');
  }
